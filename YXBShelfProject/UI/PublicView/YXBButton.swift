...
@objc class YXBButton: UIButton {
    ...
    @objc init(postionInt: Int, interitemSpace space: CGFloat = 0) {
        switch postionInt {
            case 0: imagePostion = .left
            case 1: imagePostion = .right
            case 2: imagePostion = .top
            case 3: imagePostion = .bottom
        default:
            imagePostion = .left
            break
        }
