...
"""
        ...
        self.nineView.viewModel.receiveAllMaiListMessage(text: tempstring, roomType: .merchant_9)
...
"""
            self.nineView.viewModel.receiveCharmListMessage(text: str, roomType: .merchant_9)
