...
class LQMessageNobbleJoinCell: LQOnlyBubbleCell {
    ...
    private func creatUI() {
        ...
        self.bubbleImageView.layerCornerRadius = 15
    ...
    override func setup(model: LQMessageModel) {
        ...
        if model.type == .joinRoom,
           ...
           let type = NobbleType(rawValue: vipLevelInt) {
            ...
            nickAtt.yy_setTextHighlight(nickAtt.yy_rangeOfAll(), color: type.nickColor, backgroundColor: .clear) {[weak self] _, att, _, _ in
