...
//    func makeBackgroundGradient(_ colorStyle: LSGradientColorStyle, direction: LSGradientDirection, locations: [NSNumber]?)
    ...
    func makeGradient(_ colors: [UIColor], direction: YXBGradientDirection, locations: [NSNumber]?)
...
//    }
    ...
    func makeGradient(_ colors: [UIColor], direction: YXBGradientDirection = .fromLeftToRight, locations: [NSNumber]? = nil) {
